...
---------------------------------------------------------------------
-- Separate dropdown ranger workspace rule
---------------------------------------------------------------------

table.insert(M.windowrules, {
    match = "match:initialClass ^(dropdown_ranger)$",
    action = "workspace special:dropdown_ranger, float on, center on, size (monitor_w*0.7) (monitor_h*0.7)"
})
